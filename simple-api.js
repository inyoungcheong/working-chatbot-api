...
async function generateResponse(conversationHistory, userMessage) {
  ...
  switch (stage) {
    ...
    case 'examination':
      ...
      break;
    case 'planning':
      systemPrompt = `They're ready for practical planning. Help break down their work into 6 specific, realistic tasks that take about 30 minutes each. Base these directly on what they've told you.`;
      break;
    default:
